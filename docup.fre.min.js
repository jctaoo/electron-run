...
const e = (e, n, t) => {
  for (let l in Object.assign(Object.assign({}, n), t)) {
    let o = n[l],
      r = t[l];
    if (o === r || 'children' === l);
    else if ('style' === l)
      if (K(r)) e.setAttribute(l, r);
      else
        for (const n in Object.assign(Object.assign({}, o), r))
          (o && r && o[n] === r[n]) ||
            (e[l][n] = (null == r ? void 0 : r[n]) || '');
    else
      'o' === l[0] && 'n' === l[1]
        ? ((l = l.slice(2).toLowerCase()),
          o && e.removeEventListener(l, o),
          e.addEventListener(l, r))
        : !(l in e) || e instanceof SVGElement
        ? null == r || !1 === r
          ? e.removeAttribute(l)
          : e.setAttribute(l, r)
        : (e[l] = r || '');
...
const t = (e) => l(null, e),
  ...
  s = (e, t, l) => {
    const [o, r] = c(n++);
    f(o[1], t) && ((o[0] = e), (o[1] = t), r.hooks[l].push(o));
  },
  i = (e, t) => {
    const l = c(n++)[0];
    return f(l[1], t) ? ((l[1] = t), (l[0] = e())) : l[0];
  },
  a = (e, n) => i(() => e, n),
  u = (e) => i(() => ({ current: e }), []),
  c = (e) => {
    const n = H(),
      t = n.hooks || (n.hooks = { list: [], effect: [], layout: [] });
    return e >= t.list.length && t.list.push([]), [t.list[e], n];
  },
  f = (e, n) => !e || e.length !== n.length || n.some((n, t) => n !== e[t]),
  d = [],
  p = [];
let h = 0;
const g = (e) => 1 === p.push(e) && y(),
  y = (() => {
    const e = () => p.splice(0, p.length).forEach((e) => e());
    if ('undefined' != typeof MessageChannel) {
      const { port1: n, port2: t } = new MessageChannel();
      return (n.onmessage = e), () => t.postMessage(null);
    }
    return () => setTimeout(e);
  })(),
  v = () => {
  ...
  b = () => {
    ...
    return (
      (null ===
        (n =
          null === (e = navigator) || void 0 === e ? void 0 : e.scheduling) ||
      void 0 === n
        ? void 0
        : n.isInputPending()) || k() >= h
    );
  },
  k = () => performance.now(),
  m = (e) => e[0];
let E,
  ...
  A = [];
const z = (e, n, t) => {
    j({ node: n, props: { children: e }, done: t });
  },
  j = (e) => {
    !e ||
      32 & e.lane ||
      ...
      (e.sibling = null),
      ((e, n) => {
        const t = { callback: e, lane: n };
        d.push(t), g(v);
      })(x.bind(null, e), e.lane));
  },
  x = (e) => {
    for (; e && !b(); ) e = C(e);
    return e ? x.bind(null, e) : (w && V(w), null);
  },
  C = (e) => {
    if ((J(e.type) ? L(e) : N(e), e.child)) return e.child;
    for (; e; ) {
      if (!w && 32 & e.lane) return (w = e), (e.lane &= -33), null;
  ...
  L = (e) => {
    (E = e), (n = 0);
    try {
      var t = e.type(e.props);
    } catch (n) {
      if (!n || 'function' != typeof n.then) throw n;
      {
        const l = M(e);
        l.laziness || ((l.laziness = []), (t = l.props.fallback)),
          l.laziness.push(n);
      }
    }
    K(t) && (t = U(t)), O(e, t);
  ...
  M = (e) => {
    for (; (e = e.parent); ) if ('Suspense' === e.type.name) return e;
  },
  N = (n) => {
    (n.parentNode = ((e) => {
      for (; (e = e.parent); ) if (!J(e.type)) return e.node;
    })(n)),
      n.node ||
        ('svg' === n.type && (n.lane |= 16),
        (n.node = ((n) => {
          const t =
            'text' === n.type
  ...
  O = (e, n) => {
    ...
    let l = e.kids || [],
      ...
      u = null,
      c = Array(o.length),
      f = (null === (t = e.sibling) || void 0 === t ? void 0 : t.node)
        ? e.sibling
        : null;
    for (; r <= i && s <= a; ) {
      let e = null;
      if (null == l[r]) r++;
        ...
        (e = o[s]), P(e, l[r]), (e.lane = 2), (c[s] = e), r++, s++;
      else if (G(l[i], o[a]))
        (e = o[a]), P(e, l[i]), (e.lane = 2), (c[a] = e), i--, a--;
      else {
        if (!u) {
          u = new Map();
          for (let e = r; e <= i; e++) {
        ...
        if (u.has(n)) {
          ...
          (e = o[s]),
            ...
            (c[s] = e),
            (l[u.get(n)] = null);
        } else (e = o[s]), (e.lane = 4), (e.node = null), (e.after = l[r]);
        s++;
      }
    }
    const d = a <= o.length - 1 ? c[a + 1] : f;
    for (; s <= a; ) {
      let e = o[s];
      e && ((e.lane = 4), (e.after = d), (e.node = null)), s++;
    }
    for (; r <= i; ) {
      let e = l[r];
      e && ((e.lane = 8), A.push(e)), r++;
    }
    for (var p = 0, h = null; p < o.length; p++) {
      const n = o[p];
      null != n &&
        ((n.parent = e),
        p > 0
          ? (h.sibling = n)
          : (16 & e.lane && (n.lane |= 16), (e.child = n)),
        (h = n));
    }
  };
...
const S = (e) => (null == e ? e : e.key),
  T = (e) => (J(e.type) ? e.type.name : e.type),
  V = (e) => {
    var n;
    e.parent ? B(e) : B(e.child),
      A.forEach(B),
      null === (n = e.done) || void 0 === n || n.call(e),
      (A = []),
      (w = null);
  };
const B = (n) => {
    var t;
    if (!n) return;
    let { type: l, lane: o, parentNode: r, node: s, ref: i } = n;
    if (J(l)) {
      !(function (e) {
        const { hooks: n, lane: t, laziness: l } = e;
        l &&
          Promise.all(l).then(() => {
            (e.laziness = null), j(e);
          }),
          n &&
            (8 & t
              ? n.list.forEach((e) => e[2] && e[2]())
              : (F(n.layout), g(() => F(n.effect))));
      })(n);
      let e = (function (e) {
        let n = e;
        for (; J(n.type); ) n = n.child;
        const t = e.after || n.after;
        (n.after = t), (n.lane |= e.lane);
        let l = n.sibling;
        for (; l; ) (l.after = t), (l.lane |= e.lane), (l = l.sibling);
        return n;
      })(n);
      return (
        (n.node = e.node),
        8 & n.lane ? B(e) : (B(n.child), B(n.sibling)),
        void (n.lane = 0)
      );
    }
    if (8 & o)
      return D(n.kids), r.removeChild(n.node), q(i, null), void (n.lane = 0);
    2 & o && e(s, n.lastProps || {}, n.props),
      4 & o &&
        r.insertBefore(
          n.node,
          null === (t = n.after) || void 0 === t ? void 0 : t.node
        ),
      (n.lane = 0),
      q(i, s),
      B(n.child),
  ...
  G = (e, n) => S(e) === S(n) && T(e) === T(n),
  I = (e) => (e ? (X(e) ? e : [e]) : []),
  q = (e, n) => {
    e && (J(e) ? e(n) : (e.current = n));
  },
  D = (e) => {
    e.forEach((e) => {
      e.kids && D(e.kids), q(e.ref, null);
    });
  },
  F = (e) => {
    e.forEach((e) => e[2] && e[2]()),
  ...
  K = (e) => 'number' == typeof e || 'string' == typeof e,
  Q = (e) => null != e && !1 !== e && !0 !== e,
  R = function (e, n) {
    const t = n || {},
      l = t.key || null,
    ...
    for (; r.some((e) => X(e)); ) r = [].concat(...r);
    return (
      r.length && (t.children = 1 === r.length ? r[0] : r),
      delete t.key,
      { type: e, props: t, key: l, ref: o }
    );
  };

function U(e) {
  return { type: 'text', props: { nodeValue: e } };
}
...
function setHtml(html) {
  return { ref: (dom) => (dom.innerHTML = html) };
}
...
const Navbar = ({ title, base, navLinks, toggleSidebar }) => {
  return /* @__PURE__ */ R(
    'header',
    {
      class:
        'fixed w-full top-0 left-0 h-12 navbar flex items-center justify-between px-5',
    },
    /* @__PURE__ */ R(
      'div',
      {
...
const Sidebar = ({ menu, title, base, showSidebar, navLinks }) => {
  const [hash, setHash] = t('');
  const sidebarRef = u(null);
  ...
  return /* @__PURE__ */ R(
    ...
    /* @__PURE__ */ R(
      ...
      /* @__PURE__ */ R(
        'h1',
        {
          class: 'text-2xl px-5 flex h-12 items-center',
        },
        /* @__PURE__ */ R(
          'a',
          {
    ...
    /* @__PURE__ */ R(
      ...
      loadingState === 'loading'
        ? /* @__PURE__ */ R(
            ...
            /* @__PURE__ */ R('div', {
              class: 'loader rounded h-4 w-32',
            }),
            /* @__PURE__ */ R('div', {
              class: 'loader rounded h-4 w-64 mt-3',
            }),
            /* @__PURE__ */ R('div', {
              class: 'loader rounded h-4 w-48 mt-3',
            })
          )
        : /* @__PURE__ */ R(
            'div',
...
const { rtrim, splitCells, escape: escape$2, findClosingBracket } = helpers;
...
const { cleanUrl, escape: escape$1 } = helpers;
...
const { getDefaults, changeDefaults, defaults } = defaults$5;
...
function updateURLHash(hash, replace) {
  if (replace) {
...
async function loadLanguages(langs) {
  await Promise.all(
    langs.map((lang) =>
      loadScript(
        `https://cdn.jsdelivr.net/npm/prismjs@${'^1.23.0'}/components/prism-${lang}.min.js`
      )
    )
  );
}
...
function getFileUrl(root, indexFile, pathname) {
  let url = root.replace(TRAILING_SLASH_RE, '');
...
const MD_PROPS_KEY = `MD_C_PROPS`;
let docupUrl = import.meta.url;
const setMdProps = (props) => {
  window[MD_PROPS_KEY] = props;
};
const getSkypackUrl = (name) => `https://cdn.skypack.dev/${name}?min`;
...
const initMarkdownComponentsProxy = () => {
...
function renderMarkdown(text) {
  ...
  renderer.link = (href, title, text2) => {
    ...
    return `<a${attrs}>${text2}</a>`;
  };
  renderer.listitem = (text2, task) => {
    return `<li${task ? ` class="task_list__item"` : ''}>${text2}</li>`;
  };
  const menu = [];
  const slugs = [];
  renderer.heading = (text2, depth, raw) => {
    if (depth === 1) {
      return '';
    }
    ...
    text2 = `<a class='anchor' href='#${slug}'>${ANCHOR_ICON}</a>${text2}`;
    return `<h${depth} class='heading' id='${slug}'>${text2}</h${depth}>`;
  };
  const html = marked_1(text, {
    renderer,
    gfm: true,
    highlight(code, lang) {
...
const App = ({ options }) => {
  ...
  const [html, setHtml] = t('');
  const [loadingState, setLoadingState] = t('loading');
  const [menu, setMenu] = t([]);
  const [showSidebar, setShowSidebar] = t(false);
  ...
  o(() => {
    ...
    Promise.all([
      ...
      .then((text) => {
        const { html: html2, menu: menu2, fns } = renderMarkdown(text);
        setHtml(html2);
        setMenu(menu2);
  ...
  return /* @__PURE__ */ R(
    ...
    showSidebar &&
      /* @__PURE__ */ R('div', {
        ...
        class:
          'sidebar_overlay fixed top-0 bottom-0 w-full bg-gray-200 bg-opacity-50',
      }),
    /* @__PURE__ */ R(Navbar, {
      toggleSidebar,
      title: options.title,
...
class Docup {
  ...
  init() {
    ...
    z(R(App, { options: this.options }), document.body);
  }
}
